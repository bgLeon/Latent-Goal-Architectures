...
class Game:
	...
	def get_observation_old(self, agent):
		...
		for i in range(N):
			for j in range(M):
				...
				# If we remove the lines below agents would oclude objects in their position to all agents
